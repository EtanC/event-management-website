...
from swagger_doc.auth import auth_login_spec, auth_register_spec, auth_logout_spec
from swagger_doc.events import events_crawl_spec, events_clear_spec, events_get_all_spec, event_create_spec, event_update_spec, event_delete_spec, event_authorize_spec, events_ai_description_spec, events_get_page_spec
from swagger_doc.profile import profile_get_spec, profile_update_details_spec, profile_update_password_spec
from swagger_doc.admin import admin_invite_spec, admin_remove_spec, is_admin_spec
from swagger_doc.user import user_events_spec, user_register_event_spec, user_manage_events_spec, user_unregister_event_spec, user_toggle_notifications_spec
from swagger_doc.database import clear_spec
from swagger_doc.definitions import definitions
from src.error import AccessError, InputError
import json
from werkzeug.exceptions import HTTPException
from src.auth import auth_google_login, auth_login, auth_register, auth_logout
from src.events import events_crawl, events_clear, events_get_all, event_create, event_update, event_delete, event_authorize, events_ai_description
from src.profile_details import get_profile_details, update_profile_details, update_profile_password
from src.admin import is_admin, invite_admin, remove_admin
from src.user import user_register_event, user_events, user_unregister_event, user_manage_events, user_toggle_notifications
